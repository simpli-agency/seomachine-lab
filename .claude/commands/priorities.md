...
- Generate detailed report in `projects/<slug>/research/YYYY-MM-DD-quick-wins.md`
...
- `projects/<slug>/research/YYYY-MM-DD-quick-wins.md` (auto-generated by script)

The command creates:
- `projects/<slug>/research/YYYY-MM-DD-priorities.md` (summarized top 10 list)
